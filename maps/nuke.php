...
<html lang="en">
  ...
  <body>
    ...
    <div id="right">
        ...
        <img class="map_img" src="../images/radars/de_nuke.png"/>
      ...
      $mysqli = new mysqli($host, $username, $password, $database);
        ...
        $sql = "SELECT id, name, nadeType, team, site, deploySpotX, deploySpotY, throwSpotX, throwSpotY, throwType, image_lineup_128, image_lineup_64, image_spot1, image_spot2, image_deploy  FROM nuke";
        ...
        <?php
          while($row = $result->fetch_assoc()) {
            ...
            ?>
            <a class="<?php echo $row["nadeType"]?>" onclick='toggleUtilDetail( <?php echo json_encode($utilDetails);?> , "nuke") ' >
        ...
        <div>
            ...
            <div class="lineupWindowContainer">
                <div class="lineupWindow">
                    <img class="lineupImage" src="../images/nuke/smoke/moto_smoke_lineup.jpg">
                </div>
            </div>

            <div style="display: flex; justify-content: center;">
                <div class="metaImages">
                    <img class="img_spot1" src="../images/nuke/smoke/moto_smoke_deploy.jpg">
                    <img class="img_spot2" src="../images/nuke/smoke/moto_smoke_spot1.jpg">
                    <img class="img_deploy" src="../images/nuke/smoke/moto_smoke_spot2.jpg">
                </div>
            </div>
