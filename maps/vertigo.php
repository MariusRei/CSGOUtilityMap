...
<html lang="en">
  ...
  <body>
    ...
    <div id="right">
        ...
        <img class="map_img" src="../images/radars/de_vertigo.png"/>
      ...
      $mysqli = new mysqli($host, $username, $password, $database);
        ...
        $sql = "SELECT id, name, nadeType, team, site, deploySpotX, deploySpotY, throwSpotX, throwSpotY, throwType, image_lineup_128, image_lineup_64, image_spot1, image_spot2, image_deploy  FROM vertigo";
        ...
        <?php
          while($row = $result->fetch_assoc()) {
            ...
            ?>
            <a class="<?php echo $row["nadeType"]?>" onclick='toggleUtilDetail( <?php echo json_encode($utilDetails);?> , "vertigo") ' >
        ...
        <div>
            ...
            <div class="lineupWindowContainer">
                <div class="lineupWindow">
                    <img class="lineupImage" src="../images/vertigo/smoke/moto_smoke_lineup.jpg">
                </div>
            </div>

            <div style="display: flex; justify-content: center;">
                <div class="metaImages">
                    <img class="img_spot1" src="../images/vertigo/smoke/moto_smoke_deploy.jpg">
                    <img class="img_spot2" src="../images/vertigo/smoke/moto_smoke_spot1.jpg">
                    <img class="img_deploy" src="../images/vertigo/smoke/moto_smoke_spot2.jpg">
                </div>
            </div>
