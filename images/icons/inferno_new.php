  ...
  <body>
            ...
            <div id="toggleTickrate">
                ...
                <div class="toggleSwitch">
                    <div  style="height: 37px; width: 100%; position: relative;">
                        ...
                        <span class="activeOptionsToggle">64</span>
                        <span>128</span> 
                    </div>
    ...
    <div id="right">
      ...
      $mysqli = new mysqli($host, $username, $password, $database);
        ...
        $sql = "SELECT id, name, nadeType, team, site, deploySpotX, deploySpotY, throwSpotX, throwSpotY, throwType, image_lineup, image_spot1, image_spot2, image_deploy  FROM inferno";
        ...
        <div class="utilities" style="display:flex;"  id="flash">    
        <?php     
          while($row = $result->fetch_assoc()) {
            $utilDetails = array(
                    "name" => $row["name"],
        ...
        <div class="utilities" style="display:flex;"  id="molo">    
        <?php     
          while($row = $result->fetch_assoc()) {
            $utilDetails = array(
                    "name" => $row["name"],
        ...
        <div class="utilities" style="display:flex;"  id="nade">    
        <?php     
          while($row = $result->fetch_assoc()) {
            $utilDetails = array(
                    "name" => $row["name"],
