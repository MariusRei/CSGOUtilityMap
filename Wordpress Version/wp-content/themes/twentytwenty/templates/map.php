  ...
  <body>
    ...
    <div class="container background">
      ...
      <nav class="nav utils-toggle">
        <a class="nav-link active" onclick="toggleUtil('smoke')" href="#">Smokes</a>
        <a class="nav-link" onclick="toggleUtil('flash')" href="#">Flashes</a>
        <a class="nav-link" onclick="toggleUtil('molo')" href="#">Molos</a>
        <a class="nav-link" onclick="toggleUtil('nade')" href="#">Nades</a>
      </nav>
      ...
      $mysqli = new mysqli($host, $username, $password, $database);
        ...
        if ($result->num_rows > 0) {
          ...
          while($row = $result->fetch_assoc()) {
            ...
            <a class="<?php echo $row["nadeType"]?>" href="../images/inferno/smokes/<?php echo $row["image"]?>.jpg" data-lightbox="<?php echo $row["nadeType"]?>">
